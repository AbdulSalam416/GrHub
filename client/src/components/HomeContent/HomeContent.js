        ...
        <section className="section-top">
          ...
          <Container>
            <div className="section-top-desc">
              <h1>Invest for Future in Stable Platform</h1>

              <h5> If you are a relatively modest investor of physical bullion bars and coins, then a popular and cost effective method of storing it is at home. If you do opt for this method of storing your bullion at home then be creative. Hide it somewhere unusual, somewhere where if you did encounter anintruder they would not stumble across it by accident.</h5>

              <a className="el-button outline" rel="noreferrer"  href="#subscribe">
                Get in Touch
              </a>
            </div>
            ...
            <div className="section-top-chart">
              <div className="chart-svg" ref={chartSvg}>
                <div className="chart-svg-top">
                  <span className="el-title--h6">Gold Price</span>
                  <span className="el-title--h7">1 year</span>
                </div>
                ...
                <div className="chart-svg-bottom">
                  ...
                  <span className="chart-svg-bottom--date">jun’22</span>
                  <span className="chart-svg-bottom--date">Sep’22</span>
                  <span className="chart-svg-bottom--date">dec’22</span>
                  <span className="chart-svg-bottom--date">mar’22</span>
                  <span className="chart-svg-bottom--date">jun’22</span>
                  <span className="chart-svg-bottom--date">Sep’22</span>
                  <span className="chart-svg-bottom--date">dec’22</span>
              ...
              <div className="chart-table" ref={chartTable}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        Gold
                        <span className="chart-table--short">Gold </span>
                      </td>
                      <td>$1,944.90</td>
                      <td>0.22%</td>
                      <td>5.74%</td>
                      <td>$12,833,756,019</td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        ...
                        S&P 500
                        <span className="chart-table--short">S&P 500</span>
                      </td>
                      <td>4,320.06</td>
                      <td>1.66%</td>
                      <td>-13.53% </td>
                    ...
                    <tr>
                      <td>
                        ...
                        Silver
                        <span className="chart-table--short">Silver</span>
                      </td>
                      <td>$23.82</td>
                      <td>1.10%</td>
                      <td>6.99% </td>
                    ...
                    <tr>
                      <td>
                        ...
                        Nasdaq
                        <span className="chart-table--short">Nasdaq</span>
                      </td>
                      <td>$13,211.81</td>
                      <td>5.35%</td>
                      <td>-12.48%</td>
                    ...
                    <tr>
                      <td>
                        <span className="chart-table--icon">
                          <img src={images["crude.jpg"]} alt="" />
                        </span>
                        Crude Oil
                        <span className="chart-table--short">Crude Oil</span>
                      </td>
                      <td>$90.33</td>
                      <td>0.57%</td>
                      <td>21.85%</td>
                ...
                <span className="chart-table--bottom">* information as of December 17, 2022</span>
              </div>
            </div>
          </Container>
        </section>
        ...
        <section className="section-trust">
          <div className="section-trust-inner">
            ...
            <div className="section-trust-desc">
              ...
              We have worked hard to put together a storage solution that provides our customers with access to high security professionally managed vaults, insurance, direct ownership of their holdings and independent audits.

We strongly believe our vaulting service offers a much better solution than a safety deposit box. Bank safety deposit boxes are becoming increasingly expensive, difficult to find and do not include insurance.
              </span>

              <Link className="el-button outline" to={"/faq"}>
              More Info              </Link>
            </div>
          </div>
          ...
          <Container>
            <div className="section-trust-info" ref={trustInfo}>
              ...
              <div className="section-trust-info-el" >
                ...
                <span className="el--subtitle el-title-h5">Investing in the Stock Industry</span>
              </div>
              ...
              <div className="section-trust-info-el">
                ...
                <span className="el--subtitle el-title-h5">Fully committed to Stock Market</span>
              </div>
            </div>
          </Container>
        </section>
        ...
        <section className="section-join">
          ...
          <h2>Join our Fund and take advantage of our 8+ years long knowledge and experience in Stock exchange</h2>
        </section>
