        ...
        setTimeout(() => {
          ...
          if (svgLines.length === tableRows.length) {
            ...
            gsap
              ...
              .to(tableTitle, { duration: drawSVGTime / 3, scrambleText: "Gold Price" }, "<")
              ...
              .to(tableTitle, { duration: drawSVGTime / 3, scrambleText: "S&P 500 Price" }, "<")
              ...
              .to(tableTitle, { duration: drawSVGTime / 3, scrambleText: "Silver Price" }, "<")
              ...
              .to(tableTitle, { duration: drawSVGTime / 3, scrambleText: "Nasdaq Price" }, "<")
              ...
              .to(tableTitle, { duration: drawSVGTime / 3, scrambleText: "Crude Oil Price" }, "<")
